...
import img from '../../assets/login/sbg.webp'
...
const Sign_Up = () => {
            ...
            .then((userCredential) => {
                ...
                if (user) {
                    Swal.fire({
                        position: "top-end",
                        icon: "success",
                        title: "acount has been created successfully !",
    ...
    return (
        <div className="set-p md:pt-40 pb-0">
            ...
            <div className="min-h-screen bg-[#EA93A3] rounded-3xl text-gray-900 flex justify-center">
                <div className="max-w-screen-xl m-0 sm:m-10 bg-[#48322C] shadow rounded-3xl overflow-hidden flex justify-center flex-1">
                        ...
                        <div className="mt-12 flex flex-col items-center">
                            ...
                            <div className="w-full flex-1 mt-8">
                                <div className="flex flex-col items-center">
                                    ...
                                    <button
                                        className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-[#EA93A3] text-[#48322C] flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5 text-xs sm:text-base">
                                ...
                                <div className="my-12 border-b text-center">
                                    <div
                                        className="leading-none px-2 inline-block text-sm text-black p-1 bg-[#EDE4D5] tracking-wide font-medium transform translate-y-1/2">
                                ...
                                <form onSubmit={handleSignup} className="mx-auto max-w-xs">
                                    ...
                                    <p className="mt-6 text-xs text-white text-center">
                                        ...
                                        <Link className='text-[#EA93A3] font-bold inline-block ml-1' to='/login'>Login</Link>
                                    </p>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div className="flex-1 bg-no-repeat bg-cover bg-indigo-100 text-center hidden md:flex" style={{ backgroundImage: `url(${img})` }}> </div>
